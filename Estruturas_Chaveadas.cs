internal class Estruturas_Chaveadas
{
    class Dictionary
    {
        ...
        // Criamos um array de strings com dados aleatórios e adicionamos ao DataGridView. 
        string[] row = new string[] { "123", "John Doe", "30", "johndoe@teste.com.br", "Estagiário" };
        dgv.Rows.Add(row);

        // Agora crio meu dicionário e declarando as chaves com os mesmos nomes das colunas do DataGridView.
